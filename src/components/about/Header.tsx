...
const Header = () => {
  return (
    <section className="lg:px-[6rem] px-[1.5rem] z-0">
      <div className="mt-[8rem] flex justify-center items-center flex-col lg:gap-8 md:gap-2">
        <div>
          <div className="flex gap-8 items-start">
            ...
            <span className="lg:text-6xl md:text-4xl text-3xl font-bold"> Who are we?</span>
          </div>
        </div>
        <p className="md:text-xl lg:text-xl font-light md:w-[90%] lg:w-[45%] text-left border-l-2 border-gray-400 px-6 ">
      ...
      <div className="flex flex-col md:flex-row lg:flex-row mt-[3rem] items-center">
        <div className="flex flex-col gap-6">
          <h1 className="font-bold lg:text-6xl md:text-4xl text-2xl">The Goal</h1>
          <p className="md:text-xl lg:text-xl font-light md:w-[80%] lg:w-[65%] text-left">
