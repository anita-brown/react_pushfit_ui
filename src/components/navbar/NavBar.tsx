...
const NavBar = () => {
  ...
  return (
    <div className=" px-16 flex justify-between items-center h-24 mx-auto">
      ...
      <div className={!nav ? "lg:hidden md:hidden px-14 fixed left-0 top-0 w-[75%] h-full bg-[red] ease-in-out duration-500" : "fixed left-[-100%]"}>
